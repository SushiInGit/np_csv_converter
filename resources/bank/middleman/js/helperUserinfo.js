...
middleman.helperUserinfo = (function () {
    ...
    function trackFileSwap(page, file) {
        const eventName = `Databank Swap: ${page.toUpperCase()}`;
        const eventDetails = {
            category: 'Databank Events',
            action: 'Swap',
            label: file,
        };
        return trackEvent(eventName, eventDetails);
    ...
    function trackFileDel(page, file) {
        const eventName = `Databank Delete: ${page.toUpperCase()}`;
        const eventDetails = {
            category: 'Databank Events',
            action: 'Delete',
            label: file,
    ...
    return {
        ...
        trackSwap: trackFileSwap,
        trackDel: trackFileDel
    };
})();
