...
middleman.printJob = function () {
	function printDiv(to_name, to_nr, owner_nr) {
		...
		createExport.document.write(`
			...
			<link rel="preload" href="resources/phone/frontend/css/phone/print.css" as="style" onload="this.rel='stylesheet'">
			...
			<script defer src="resources/phone/backend/vendors/html2canvas.min.js"></script>
			</head>
			...
			<script defer src="resources/phone/middleman/phone/printJobFunction.js"></script>
			</body></html>
		`);
