        ...
        popupDivBody.innerHTML = `
            <div class="model">
                ...
                <a href="#" onclick="frontend.popupPhonebookOverview.showAddContact()">
                    <div class="card full">
                        <img src="https://sushiingit.github.io/np_csv_converter/resources/public/image/phonebook/add.png">
                        <span>Add new Contact</span>
                    </div>
                </a>
                <a href="#" onclick="frontend.popupPhonebook.render()">
                    <div class="card half">
                        <img src="https://sushiingit.github.io/np_csv_converter/resources/public/image/phonebook/vanilla.png">
                        <span>Importer from <br>Textfile / Excelfile / MDT</span>
                    </div>
                </a>
                <a href="#" onclick="frontend.popupPhonebook_NP.render()">
                    <div class="card half">
                        <img src="https://sushiingit.github.io/np_csv_converter/resources/public/image/phonebook/npphone.png">
                        <span>NP-Phone Import</span>
                    </div>
                </a>
                <a href="#" onclick="frontend.popupPhonebook_NPLL.render()">
                    <div class="card half">
                        <img src="https://sushiingit.github.io/np_csv_converter/resources/public/image/phonebook/llphone.png">
                        <span>Lemon-List Import</span>
                    </div>
                </a>
                <a href="#" onclick="frontend.popupPhonebookOverview.export()">
                    <div class="card half">
                        <img src="https://sushiingit.github.io/np_csv_converter/resources/public/image/phonebook/download.png">
