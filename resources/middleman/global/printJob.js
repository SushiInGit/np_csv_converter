...
middleman.printJob = function () {
    ...
    function printDiv(divId) {
        ...
        newWindow.document.write('<container><div class="grid-wrapper"><div class="output" style="grid-area: 1/1/5/7"><div class="messages">');
        newWindow.document.write(printContents);
        newWindow.document.write('</div></div></div></container>');
